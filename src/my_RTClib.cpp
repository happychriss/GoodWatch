...
#define BM_ALARM_2_ENABLED  0b00000010
    uint8_t c = read_i2c_register(DS3231_ADDRESS, DS3231_CONTROL, RTCWireBus);
    ...
    if (cc) {
        ...
        RTCWireBus->requestFrom(DS3231_ADDRESS, 3);
        uint8_t m = RTCWireBus->read();
        uint8_t h = RTCWireBus->read();
        uint8_t d = RTCWireBus->read();
